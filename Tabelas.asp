...
<div id="tudo">
	...
	<div id="conteudo">
		<div id="menu">
			<ul><hr>
			<h2>
				<li><a href="Inc_compromisso.asp?competencia=<%=request.form("comp")%>" title="Inclusao de Compromisso">Compromisso</a></li>
				<li><a href="Exc_despesa_mensal.asp?competencia=<%=request.form("comp")%>" title="Gera Controle de Despesas">Controle de Despesas </a></li>
				<li><a href="Inc_banco.asp" title="Inclusao de Banco">Banco</a></li>
				<li><a href="Inc_formaPgto.asp" title="Inclusao de Forma de Pagamento">Forma Pgto</a></li>
