...
%>	
			<TR align="center">
				...
				<td></td>
				<TD align="right">&nbsp;&nbsp;<a href="Alt_despesa.asp?codDespesa=<%=codDespesa%>">Editar</a>&nbsp;&nbsp;&nbsp;<a href="Exc_pagamento.asp?codDespesa=<%=codDespesa%>">Pagar</a>&nbsp;</TD>
				<td></td>
			</TR>			
<%	
...
<p><p>
	<center><input type = "submit" value = "  I M P R I M I R  " onClick="window.open('Imp_despesas.asp?competencia=<%=competencia%>')"/></center>
